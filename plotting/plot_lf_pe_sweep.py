...
ax[0].set_yscale('log')
ax[1].set_yscale('log')
ax[0].set_title('asinh')
ax[1].set_title('no scale')
ax[0].set_xlabel('Epochs')
ax[1].set_xlabel('Epochs')
ax[0].set_ylabel(r'$1-R^2$')
ax[1].set_ylabel(r'$1-R^2$')
# plt.legend()
# Legend
pe_legend = [
    Line2D([0], [0], color=pe_colors[p], lw=2, label=f'PE = {p}')
...
plt.tight_layout(rect=[0, 0.06, 1.0, 1.0])
plt.savefig('thesis_plots/pe_sweep_mse_asinh_noscale.pdf')