...
# python3 run_model_test.py --pretrained_path results/dispersion_all_models_2/ResNet-152_lr-0.001_wd-0.01_bs-128_epochs-1000_cosine_warmup-18750.0_clipgrad-True_pe-encoder-log_pe-4_mse.pth --model 'resnet' --model_name 'ResNet-152' --size '152' --version None --task 'dispersion' --pe_encoder log --loss_function 'mse'
...
python3 run_model_test.py --pretrained_path results/dispersion_all_models_2/ConvNeXt-RMS-Atto_lr-0.001_wd-0.01_bs-128_epochs-1000_cosine_warmup-18750.0_clipgrad-True_pe-encoder-log_pe-4_mse.pth --model 'convnext' --model_name 'ConvNeXt-RMS-Atto' --size 'atto' --version 'rms' --task 'dispersion' --pe_encoder log --loss_function 'mse'
# python3 run_model_test.py --pretrained_path results/dispersion_all_models_2/ConvNeXt-Femto_lr-0.001_wd-0.01_bs-128_epochs-1000_cosine_warmup-18750.0_clipgrad-True_pe-encoder-log_pe-4_mse.pth --model 'convnext' --model_name 'ConvNeXt-Femto' --size 'femto' --version 'v1' --task 'dispersion' --pe_encoder log --loss_function 'mse'
