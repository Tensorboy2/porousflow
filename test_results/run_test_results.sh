...
python3 run_model_test.py --pretrained_path results/dispersion_convnext_long_test/ConvNeXt-Atto_lr-0.0005_wd-0.05_bs-128_epochs-1500_cosine_warmup-6250.0_clipgrad-True_pe-encoder-log_pe-4_mse.pth --model 'convnext' --model_name 'ConvNeXt-Atto' --size 'atto' --version 'v1' --task 'dispersion' --pe_encoder log --loss_function 'rmse'
