...
for i in range(5):
    ...
    data = zarr.open(f'results/pe_sweep/ConvNeXt-Atto_lr-0.0008_wd-0.1_bs-128_epochs-200_cosine_warmup-2000_clipgrad-True_pe-encoder-_pe-{i}_metrics.zarr', mode='r')
...
plt.grid(alpha=0.3)
plt.savefig('update_plots/convnext-atto_pe_sweep_r2.pdf')
plt.close()
