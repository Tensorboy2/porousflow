...
plt.tight_layout()
plt.savefig('thesis_plots/Dx_vs_porosity.pdf', bbox_inches='tight')
...
plt.tight_layout()
plt.savefig('thesis_plots/Dy_vs_porosity.pdf', bbox_inches='tight')
fig, axes = plt.subplots(len(pe_indices), 4, figsize=(7.2, 7.2))
# fig.suptitle('Dx components vs Porosity', fontsize=16, fontweight='bold')
...
plt.tight_layout()
plt.savefig('thesis_plots/Dx_vs_porosity_asinh.pdf', bbox_inches='tight')
...
plt.tight_layout()
plt.savefig('thesis_plots/Dy_vs_porosity_asinh.pdf', bbox_inches='tight')
